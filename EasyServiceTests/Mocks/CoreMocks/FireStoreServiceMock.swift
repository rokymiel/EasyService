...
//    var stubbedLoadDocumentsResultTErrorVoidCompletionResult: (Result<[Decodable], Error>, Void)?
//
...
//    var stubbedLoadDocumentsWhereStringIsEqualToAnyResultTErrorVoidCompletionResult: (Result<[T], Error>, Void)?
//
...
//    var stubbedLoadDocumentsWhereStringAnyResultTErrorVoidCompletionResult: (Result<[T], Error>, Void)?
//
...
//    var stubbedLoadDocumentsWhereStringAnyResulttypeDocumentChangeTypeitemTErrorVoidCompletionResult: (Result<[(type: DocumentChangeType, item: T?)], Error>, Void)?
...
//    var stubbedLoadDocumentsWhereStringIsEqualToAnyResulttypeDocumentChangeTypeitemTErrorVoidCompletionResult: (Result<[(type: DocumentChangeType, item: T?)], Error>, Void)?
...
//    var stubbedLoadDocumentIdStringCompletionResult: (Result<T, Error>, Void)?
//
...
//    var stubbedLoadDocumentIdListenerListenerResult: (Result<T, Error>, Void)?
